...
| Folder | Purpose |
|---|---|
| [`frontend/`](frontend/) | The single-page web app served from the XIAO ESP32-C3 over its WiFi access point. One canonical SPA at `solesense-v2/` (auth + AI Coach). See [`frontend/README.md`](frontend/README.md). |
