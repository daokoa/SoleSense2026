...
- Records at 50 Hz: 6 FSR channels (matrix-scan via D3/D10 power × A0/A1/A2 ADC) + 6 IMU axes
...
GPIO6  / SDA  ── MPU-6050 I²C SDA
GPIO7  / SCL  ── MPU-6050 I²C SCL
GPIO9  / D9   ── deep-sleep wake (active-LOW button to GND)
```

Each ADC pin needs a 10 kΩ pulldown to GND. The FSR matrix is documented in the [root README](../../README.md#pin-map).
